---
name: hermes-skill-github-repo-management
description: Clone, create, fork, and manage GitHub repositories, remotes, and releases. Use when the user explicitly requests this capability or a closely related task.
---
