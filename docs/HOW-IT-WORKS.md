...
![Step-by-step workflow for GitHub Repository Management](../assets/workflow.svg)
...
![Safety and approval boundaries for GitHub Repository Management](../assets/safety-boundary.svg)
