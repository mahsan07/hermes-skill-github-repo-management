...
Github Repo Management is a focused, shareable agent workflow.

## What it does

Clone, create, fork, and manage GitHub repositories, remotes, and releases. Use when the user explicitly requests this capability or a closely related task.
