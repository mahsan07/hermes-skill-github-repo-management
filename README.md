<p align="center">
  <img src="assets/system-map.svg" alt="Detailed system map for GitHub Repository Management" width="100%">
</p>
...
Tool integrations can create accidental side effects when authentication, scope, preview, execution, and verification are not separated. **GitHub Repository Management** turns that work into an explicit sequence with visible inputs, outputs, review points, and completion evidence.

## Why the repository has this name

The shared `hermes-skill-` prefix identifies this as a portable Hermes workflow package. `github-repo-management` names the capability directly—github repo management—so the repository remains searchable and understandable outside the original AI-OS workspace. The public title is **GitHub Repository Management**.
...
| What does it do? | Clone, create, fork, and manage GitHub repositories, remotes, and releases. |
...
![GitHub Repository Management system map](assets/system-map.svg)

## Operation sequence

![GitHub Repository Management actor and data sequence](assets/operation-sequence.svg)
...
![Illustrative output produced by GitHub Repository Management](assets/example-output.svg)
